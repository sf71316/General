...
namespace General.Data.ColumnMapper
{
    public static class ExtensionMethods
    {
        ...
        public static MappedType<T> RegisterType<T>(this ColumnMappingCollection mappings)
        {
            ...
            if (mappings.Mappings.ContainsKey(typeof(T)))
            {
        ...
        public static ColumnMapping<T> ToDbType<T>(this PropertyMapping<T> propertyMapping, DbType dbType)
        {
            if (propertyMapping == null)
                throw new ArgumentNullException(nameof(propertyMapping));
            ...
            columnMapping.MappedType = propMapping.MappedType;
            columnMapping.PropertyName = propMapping.PropertyName;
            columnMapping.DbType = dbType;
            columnMapping.MappedType.DefineDbMapping(columnMapping);
